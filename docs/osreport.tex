...
\begin{document}
    ...
    \chapter{Testing the \ii{eggshell}}
        \section{Introduction}
            ...
            the site. The types included \ii{memory} and \ii{debugging}.
            The methods included \ii{manual}, and \ii{scripted}.

            \subsection{Scripted method}
                The scripted method utilised a command that was built in
                the \tx{main} file of the eggshell, and can be tested by
                running the eggshell using the command \tx{./eggshell test}.

                This will launch the eggshell and immediately source whatever
                is in the file \tx{testinput.txt}, after which the eggshell
            ...
            \subsection{Debugging tests}
                ...
                \bb{functional}. These were the most important tests, as if
                ...
                In order to debug the code, \tx{gdb} was used.
            ...
            \subsection{Memory tests}
                ...
                \bb{memory} within the eggshell, such as memory leaks, using 
                ...
                The tool used for these tests was \tx{valgrind}.
        ...
        \section{Tests}
            ...
            \endgroup
                ...
                such as \tx{all}, \tx{vars}, \tx{chdir}, and \tx{source}.

                \clearpage

                \bb{\myul{Output of \tx{./eggshell test}}}
                \begingroup
                    \fontsize{10pt}{10pt}\selectfont
                    \inputminted[breaklines]{text}{../output.txt}
                \endgroup

                \bb{\myul{NOTE:}} Output for manual testing is omitted due to
    ...
    \chapter{Conclusion}
        ...
        The default makefile in the project uses the \tx{clang} compiler. If 
        you do not have said compiler, you could run \tx{./switch.sh} which 
        ...
        \ii{(If the link doesn't work, this is the URL:\\ \tx{https://github.com/MasterTextman/eggshell})}
